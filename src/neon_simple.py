...
def molar_frac(T, p, eq_ratio, H2, O2, N2, H2O, OH, O, H, NO, Ne):
    ...
    X_guess = np.array([3e-3, 1e-3, 0.45, 0.23, 1e-3, 1e-5, 1e-4, 3e-4, 0.3])
...
if __name__ == '__main__':
    ...
    #    X = molar_frac(T_target, p, eq_ratio, H2, O2, N2, H2O, OH, O, H, NO, Ne, n_Ne)
    #    
    ...
    X = molar_frac(T_target, p, eq_ratio, H2, O2, N2, H2O, OH, O, H, NO, Ne)

    # Properties:
    n_tot_f = rt.get_final_moles(X, eq_ratio)
    n_Ne = n_tot_f*X[8]
    H_react = rt.H_react_Ne(eq_ratio, H2, O2, N2, n_Ne, Ne)
    H_prod = rt.H_prod_Ne(T_target, X, eq_ratio, H2, O2, N2, 
                          H2O, OH, O, H, NO, Ne, n_tot_f)

    print(f"n_tot = {n_tot_f:.2f}")
    print(f"H_react = {H_react:.2f} J")
    print(f"H_prod({T_target:.2f}) = {H_prod:.2f} J")
    print(f"Flame temperature = {T_target:.2f} K")
    print(f"X_H2 = {X[0]*100:.3f}%")
    print(f"X_O2 = {X[1]*100:.3f}%")
    print(f"X_N2 = {X[2]*100:.3f}%")
    print(f"X_H2O = {X[3]*100:.3f}%")
    print(f"X_OH = {X[4]*100:.3f}%")
    print(f"X_O = {X[5]*100}%")
    print(f"X_H = {X[6]*100:.3f}%")
    print(f"X_NO = {X[7]*100:.3f}%")
    print(f"X_Ne = {X[8]*100:.3f}%")
